...
public class Principal {
	public static void main(String[] args) {
		...
		String txtsalario, txtbonus, txtGratificacao;
		while (opte!='7'){
			...
			case '2':nome = JOptionPane.showInputDialog(null,"Nome?");
					 ...
					 txtGratificacao=JOptionPane.showInputDialog(null,"Gratificacao?");
					 float gratificacao = Float.parseFloat(txtGratificacao);
					 Diretor d = new Diretor(nome,setor,/salfixo,gratificacao);
					 lista.add(d);
			...
			case '3':nome = JOptionPane.showInputDialog(null,"Nome?");
	                 setor = JOptionPane.showInputDialog(null,"Setor?");
	                 txtsalario=JOptionPane.showInputDialog(null,"Salario Fixo?");
			         float salariofixo = Float.parseFloat(txtsalario);
			         txtbonus=JOptionPane.showInputDialog(null,"Bonus?");
			         float bonus = Float.parseFloat(txtbonus);
			         Caixa c = new Caixa(nome,setor,salariofixo,bonus);
			         lista.add(c);
			         JOptionPane.showMessageDialog(null,"Inseriu caixa com sucesso");
			         break;
